...
export default function ReclamoWizard({ categoria, onClose, whatsappUrl }: ReclamoWizardProps) {
  ...
  const handleFoto = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = (loadEvent) => setFotoPreview(loadEvent.target?.result as string);
